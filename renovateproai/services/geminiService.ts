    ...
    const response = await ai.models.generateContent({
      ...
      contents: {
        parts: [
          ...
          { text: "Analyze this room or construction site. List the materials present, the architectural style, and suggest 3 potential renovations that would increase value." }
        ]
      }
    });
